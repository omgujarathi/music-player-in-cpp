...
void play(struct node *first)
{
	...
	cin >> A;
	system ("CLS");
	if (A == 1){PlaySound(0, 0, 0); cout << "To goto menu ";system ("PAUSE");  }
	if (A == 2){ }
    push (song);
    break;
        }
...
int main()
{
    ...
    do{
        ...
        switch(choice)
        {
            ...
            break;
            case 6:
			cout<<"Press 1 to play single song and 2 for playing entire playlist\n\n";
			cin>>opt;
			if(opt==1){
			play(start);}
			else if(opt==2){
